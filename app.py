...
def procesar_faltantes(faltantes_df, inventario_api_df, columnas_adicionales, bodega_seleccionada=None):
    faltantes_df.columns = faltantes_df.columns.str.lower().str.strip()
    inventario_api_df.columns = inventario_api_df.columns.str.lower().str.strip()

    if bodega_seleccionada:
        inventario_api_df = inventario_api_df[inventario_api_df['bodega'] == bodega_seleccionada]
...
# Cargar inventario para mostrar opciones de bodega
inventario_api_df = load_inventory_file()
bodegas_disponibles = inventario_api_df['bodega'].unique()
bodega_seleccionada = st.selectbox("Selecciona la bodega para filtrar:", options=bodegas_disponibles)
